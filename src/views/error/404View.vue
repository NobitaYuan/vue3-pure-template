...
<template>
    <div class="errorpage">
        ...
        <button class="backBtn btn3" @click="$router.replace('/index')">
            <div class="icon">
                <img src="https://tk-1253967950.cos.ap-guangzhou.myqcloud.com/shineResume_v2/aiResume/icons/backIcon.svg" />
            </div>
            <div class="text">回首页</div>
        </button>
    </div>
</template>
